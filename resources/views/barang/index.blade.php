<x-app-layout>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="py-3 px-4 border-b border-gray-300">
                                ...
                                <form action="{{ route('barang.destroy', $barang->id_barang) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus item ini?');" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
    ...
    <div id="modal" class="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center hidden">
        <div class="bg-white dark:bg-gray-700 rounded-lg p-6 w-1/3">
            ...
            <form id="modal-form" action="{{ route('barang.ambil',$barang->id_barang) }}" method="POST">
                @csrf
